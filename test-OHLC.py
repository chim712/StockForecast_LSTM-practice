...
CLOSE_COL = list(df.columns).index(("Close", ticker))  # should be 3
...
print(f"\n[TEST RMSE ({ticker} OHLC, 30-step path)]")
...
print(f"\n[TEST Direction Accuracy (30-day ahead up/down, {ticker} OHLC)]")
...
print(f"\n[Monthly 30-day RMSE ({ticker} OHLC)]")
...
print(f"\n[Monthly 30-day Direction Accuracy ({ticker} OHLC)]")
